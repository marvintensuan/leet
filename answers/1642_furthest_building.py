...
if __name__ == "__main__":
    ...
    CASES = (
        (furthest_building(heights=[4, 2, 7, 6, 9, 14, 12], bricks=5, ladders=1), 4),
        (furthest_building(heights=[4, 12, 2, 7, 3, 18, 20, 3, 19], bricks=10, ladders=2), 8),
        (furthest_building(heights=[14, 3, 19, 3], bricks=17, ladders=0), 3),
        (furthest_building(heights=[1, 5, 1, 2, 3, 4], bricks=4, ladders=1), 5),
    )
